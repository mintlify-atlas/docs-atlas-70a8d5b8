...
<Accordion title="The TODO pattern">
```javascript
...
<Accordion title="The stub pattern">
```javascript
function createUser(name, email) {
...
<Accordion title="The partial pattern">
```javascript
